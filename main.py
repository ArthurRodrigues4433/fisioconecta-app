...
# Importa os roteadores de autenticação e pedidos
from auth_routes import auth_router
from order_routes import order_router
from frontend_routes import router_frontend
from fastapi.staticfiles import StaticFiles

# Inclui as rotas no app principal
app.include_router(auth_router)   # rotas relacionadas a autenticação (/auth/...)
app.include_router(order_router)  # rotas relacionadas a pedidos (/order/...)
